...
describe("Create Order Use Case", () => {
  beforeAll(async () => {
    ...
    const product1 = await prisma.product.create({
      data: {
        ...
        quantity: 10,
        image: "foto.jpg",
        storeId: "f6d6a0a6-2f1c-486f-88ff-740469735339", // Agora enviados no corpo
        subcategoryId: "f6d6a0a6-2f1c-486f-88ff-740469735338",
  ...
  it("deve criar um pedido com itens", async () => {
    ...
    const response = await request(app.server)
      ...
      .send({
        userId: "9f75e18a-c61f-4dff-ae82-f07b799679b6",
        storeId: "f6d6a0a6-2f1c-486f-88ff-740469735339",
        latitude: -23.55052,
        longitude: -46.633308,
        totalAmount,
        validated_at: null,
